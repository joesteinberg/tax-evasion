...
evasion_type = ['evasion','no_evasion','evasion_hi_ec1','evasion_hi_ec2','evasion_hi_ec3','evasion_nodrev','evasion_chi0']
gama=[0.43172371688765909, 0.42913860042472707,0.43172371688765909,0.43172371688765909,0.43172371688765909,0.43172371688765909,0.43172371688765909]
sigma=4
policy = ['warren']
...
axes.plot(results_tauk[5]['tauk'],results_tauk[5][c],color=colors[5],dashes=dashes[5],label='No detection revenues',linewidth=2,alpha=0.8)
...
axes.plot(results_taua[5]['taua'],results_taua[5][c],color=colors[5],dashes=dashes[5],label='No detection revenues',linewidth=2,alpha=0.8)
axes.plot(results_taua[6]['taua'],results_taua[6][c],color=colors[6],dashes=dashes[6],label='No concealed collateral',linewidth=2,alpha=0.8)
...
file.write('\\toprule\n')
#file.write('Outcome & Baseline & No evasion & \\makecell{High transfer\\\\cost} & \\makecell{High detection\\\\rate} & \\makecell{High penalty} & \\makecell{No detection\\\\revenues}\\\\\n')
file.write('Outcome & Baseline & \makecell{No\\\\evasion} & \\makecell{High\\\\transfer cost} & \\makecell{High\\\\detection rate} & \\makecell{High\\\\penalty}\\\\\n')
file.write('\\midrule')


file.write('\\multicolumn{6}{l}{{\\textit{(a) Benchmark equilibrium}}}\\\\\n')
file.write('Concealed wealth (\% total wealth)')
for i in range(N):
...
file.write('\\multicolumn{6}{l}{{\\textit{(b) Revenue-maximizing capital income tax}}}\\\\\n')
...
file.write('Concealed wealth (benchmark = 1)')
for i in range(N):
    j = imaxR_tauk[i]
...
file.write('Lost revenues (benchmark = 1)')
for i in range(N):
    j = imaxR_tauk[i]
...
file.write('\\multicolumn{6}{l}{{\\textit{(c) Revenue-maximizing wealth tax}}}\\\\\n')
...
file.write('\\multicolumn{6}{l}{\\textit{(d) Warren wealth tax}}\\\\\n')
